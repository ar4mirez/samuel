...
- ✓ Use async/await over raw promises (better error handling, readability)
...
- **Zod**: Runtime type validation + TypeScript inference
...
- **ts-node** or **tsx**: Run TypeScript directly (development)
