...
> **Purpose**: Guide for creating reusable AI agent skills
>
> **Use When**: Building a capability module for AI agents
>
> **Output**: New skill in `.agent/skills/<skill-name>/`
...
If the skill is significant, record in `.agent/memory/`:

```markdown
# .agent/memory/YYYY-MM-DD-skill-name.md
