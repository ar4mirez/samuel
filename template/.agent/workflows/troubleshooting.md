...
> **Purpose**: Emergency procedures when stuck, tests failing, or errors occurring
>
> **When to use**: After 30+ minutes stuck on same issue
...
4. **Search for Similar Issues**
   ...
   - Review `.agent/memory/` for similar past problems
...
4. **Document in Memory**
   - Create `.agent/memory/YYYY-MM-DD-security-fix-NAME.md`
...
- [ ] Documented in `.agent/memory/` if significant
