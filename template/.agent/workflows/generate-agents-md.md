# Workflow: Generate AGENTS.md

> **Purpose**: Extract operational content from CLAUDE.md to create a universal AGENTS.md file
>
> **Use When**: You need cross-tool compatibility with Cursor, Codex, Copilot, or other AI agents
...
- **Language Guide Skills**: [.agent/skills/](./agent/skills/)
...
**Solution**: Use this workflow to generate actual file instead
