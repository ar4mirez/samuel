...
1. Check current version
2. Compare with 1.7.0 requirements
...
|----------|--------------|
| [Initialize Project](initialize-project.md) | For first-time installation |
| [Cleanup Project](cleanup-project.md) | Remove unused guides after update |
| [Generate AGENTS.md](generate-agents-md.md) | Regenerate AGENTS.md after update |
| [Document Work](document-work.md) | Document the update decision |
